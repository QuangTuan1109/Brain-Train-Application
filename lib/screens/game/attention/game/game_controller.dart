...
import 'package:flutter_application_1/screens/game/attention/enemy/enemy_factory.dart';
import 'package:flutter_application_1/screens/game/attention/game/game_setting.dart';
import 'package:flutter_application_1/neutual/neutual_component.dart';
    ...
    switch (instruction) {
      case GameControl.WEAPON_BUILDING:
        ...
        if (component != null) {
          ...
          component.blockMap != component.collision(controller.gateEnd);
