...
import 'package:flutter_application_1/screens/game/attention/game/game_test%20copy.dart';
...
Widget _pauseMenuBuilder(BuildContext buildContext, GameMain2 game) {
  return Center(
      child: Container(
    width: 100,
    height: 100,
...
Widget _nextMenuBuilder(BuildContext buildContext, GameMain2 game) {
  return Center(
      child: Container(
    width: 100,
    height: 100,
...
Widget _gameOverBuilder(BuildContext buildContext, GameMain2 game) {
